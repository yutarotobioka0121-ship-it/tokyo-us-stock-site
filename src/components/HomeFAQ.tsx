...
const faqs = [
  {
    ...
    answer:
      "米国株投資の始め方は大きく3ステップです。①SBI証券・楽天証券などのネット証券で口座を開設する、②新NISA口座を設定する、③S&P500などのインデックスファンドを毎月一定額で積立購入する、という流れが初心者におすすめです。「何を買えばいいかわからない」「口座の設定が不安」という方は、当クラブの少人数制勉強会で一つひとつ丁寧に解説しています。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "はい、新NISAの「つみたて投資枠（年間120万円）」と「成長投資枠（年間240万円）」の両方で、米国株・米国ETF・S&P500連動ファンドを購入できます。合計年間360万円・生涯1,800万円まで非課税で運用できるため、長期の米国株投資との相性は抜群です。口座の選び方・設定手順まで、当クラブのNISA初心者勉強会でわかりやすく解説しています。",
  },
];
