...
export const metadata: Metadata = {
  title: 'NISA（ニーサ）とは？基本から新制度の活用法まで解説 | 東京 米国株 勉強会 - 東京米国株クラブ',
  description: '東京の初心者向け米国株勉強会「東京米国株クラブ」が、NISA（少額投資非課税制度）の基本仕組みやメリットを3,000字以上で徹底解説。口座開設手順やつみたて枠・成長投資枠の賢い選び方、出口戦略まで網羅。',
  alternates: {
