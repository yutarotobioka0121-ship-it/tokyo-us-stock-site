...
import { ArrowRight, CheckCircle2, ShieldCheck, Users, TrendingUp, Heart, BookOpen, PieChart, UserCheck, Calendar, ChevronRight } from "lucide-react";
        ...
        <section className="section-padding" style={{ background: 'white' }}>
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <h2 className="section-title" style={{ marginTop: '0.75rem' }}>最新ブログ記事</h2>
              ...
              {latestPosts.map((post) => (
                ...
                >
                  <article
                    ...
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = 'translateY(-4px)'; (e.currentTarget as HTMLElement).style.boxShadow = '0 12px 32px rgba(176,58,46,0.13)'; }}
                  ...
                  >
                    {/* サムネイル */}
                    <div style={{ width: '100%', aspectRatio: '16/9', background: 'linear-gradient(135deg, var(--bg-warm) 0%, rgba(176,58,46,0.08) 100%)', position: 'relative', overflow: 'hidden', flexShrink: 0 }}>
                      {post.cover ? (
                        <Image
                          src={post.cover}
                          alt={post.title}
                    ...
                    <div style={{ padding: '1.25rem 1.5rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
                      ...
                      <h3 style={{ fontSize: '1rem', fontWeight: '800', lineHeight: '1.5', color: 'var(--text-main)', margin: 0 }}>
                        {post.title}
                      </h3>
                      {post.summary && (
                        <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', lineHeight: '1.7', margin: 0, display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
                          {post.summary}
                        </p>
                      )}
                      <div style={{ marginTop: 'auto', paddingTop: '0.75rem', display: 'flex', alignItems: 'center', gap: '0.25rem', color: 'var(--primary)', fontSize: '0.875rem', fontWeight: '700' }}>
            ...
            <div style={{ textAlign: 'center' }}>
              <Link href="/blog" className="btn btn-outline" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.9rem 2.5rem', borderRadius: '50px', fontSize: '1rem', fontWeight: '800' }}>
