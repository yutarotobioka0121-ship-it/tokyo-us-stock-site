        ...
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              NISA初心者勉強会の開催日程一覧です。<br className="sp-hide" />少人数制（定員4名）のため、お早めにお申し込みください。
            </p>
          </div>
          ...
          <div className="schedule-mobile-only">
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              {sortedSessions && sortedSessions.length > 0 ? (
                ...
                <div className="glass-card" style={{ padding: '2rem', textAlign: 'center', color: 'var(--text-muted)' }}>現在、予定されている勉強会はありません。</div>
              )}
            </div>
          </div>
        </div>
