      ...
      <section className="seminar-hero" style={{ background: 'var(--bg-warm)', padding: '120px 0 60px', textAlign: 'center' }}>
        <div className="container">
          ...
          <h1 className="post-title" style={{ marginBottom: '1rem', fontSize: 'clamp(2rem, 5vw, 3rem)' }}>
            初心者から始める、<br className="sp-hide"/>一生モノの米国株投資勉強会
          </h1>
        ...
        <div className="container">
          ...
          <div className="problems-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', maxWidth: '900px', margin: '0 auto' }}>
            <div className="problem-card glass-card" style={{ padding: '2rem', textAlign: 'center' }}>
              ...
              <p style={{ fontWeight: '700', fontSize: '1.1rem' }}>投資に興味はあるけど、<br/>何から始めればいいか分からない…</p>
            </div>
            <div className="problem-card glass-card" style={{ padding: '2rem', textAlign: 'center' }}>
              <Target size={40} color="var(--primary)" style={{ margin: '0 auto 1rem' }} />
              <p style={{ fontWeight: '700', fontSize: '1.1rem' }}>独学で始めてみたけど、<br/>ギャンブルみたいになってしまって不安…</p>
            </div>
            <div className="problem-card glass-card" style={{ padding: '2rem', textAlign: 'center' }}>
              <Users size={40} color="var(--primary)" style={{ margin: '0 auto 1rem' }} />
              <p style={{ fontWeight: '700', fontSize: '1.1rem' }}>同世代で投資について、<br/>気軽に話せる仲間がいない…</p>
            </div>
          </div>
      ...
      <section className="section-padding" style={{ background: 'white' }}>
        <div className="container">
          ...
          <div className="timeline" style={{ maxWidth: '600px', margin: '0 auto', position: 'relative' }}>
            ...
            <div style={{ padding: '1.5rem', borderLeft: '4px solid var(--primary)', marginBottom: '1.5rem', background: 'var(--bg-warm)', borderRadius: '0 16px 16px 0' }}>
              <h4 style={{ color: 'var(--primary)', fontWeight: '800', marginBottom: '0.5rem' }}>3. なぜ「米国株」なのか？</h4>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>世界経済の中心である米国の強さと、過去のデータに基づいた長期投資の優位性について分かりやすく説明します。</p>
            </div>
            <div style={{ padding: '1.5rem', borderLeft: '4px solid var(--primary)', background: 'var(--bg-warm)', borderRadius: '0 16px 16px 0' }}>
              <h4 style={{ color: 'var(--primary)', fontWeight: '800', marginBottom: '0.5rem' }}>4. 質疑応答・交流タイム</h4>
      ...
      <section className="section-padding" style={{ background: 'white' }}>
        <div className="container">
          ...
          <div className="faq-container" style={{ maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <div className="faq-item glass-card" style={{ padding: '2rem' }}>
              <h4 style={{ display: 'flex', gap: '1rem', alignItems: 'center', fontSize: '1.1rem', color: 'var(--primary-dark)', marginBottom: '1rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                ...
                <p style={{ color: 'var(--text-muted)', lineHeight: '1.6', margin: 0, paddingTop: '0.2rem' }}>もちろんです！本勉強会は「これから投資を始めたい」「基礎から学び直したい」という方を主な対象としています。専門用語は極力使わず、分かりやすく丁寧にお伝えします。</p>
              </div>
            </div>
            <div className="faq-item glass-card" style={{ padding: '2rem' }}>
              <h4 style={{ display: 'flex', gap: '1rem', alignItems: 'center', fontSize: '1.1rem', color: 'var(--primary-dark)', marginBottom: '1rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                <span style={{ color: 'var(--text-muted)', padding: '0.2rem 0.8rem', fontWeight: '800', fontSize: '1.1rem' }}>A</span>
                <p style={{ color: 'var(--text-muted)', lineHeight: '1.6', margin: 0, paddingTop: '0.2rem' }}>参加費は無料です（対面の場合はご自身のカフェ代のみご負担ください）。強引な勧誘や金融商品の販売は一切行っておりませんので、安心してご参加ください。</p>
              </div>
            </div>
            <div className="faq-item glass-card" style={{ padding: '2rem' }}>
              <h4 style={{ display: 'flex', gap: '1rem', alignItems: 'center', fontSize: '1.1rem', color: 'var(--primary-dark)', marginBottom: '1rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                <span style={{ color: 'var(--text-muted)', padding: '0.2rem 0.8rem', fontWeight: '800', fontSize: '1.1rem' }}>A</span>
                <p style={{ color: 'var(--text-muted)', lineHeight: '1.6', margin: 0, paddingTop: '0.2rem' }}>はい、参加者の多くがお一人での参加です。アットホームな雰囲気ですので、すぐに馴染んでいただけます。</p>
              </div>
            </div>
          </div>
        </div>
