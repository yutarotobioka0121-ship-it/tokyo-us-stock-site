...
`;
    ...
    const isNisa = typeof sessionId === 'string' && sessionId.includes('NISA初心者勉強会');
    ...
    const mailOptions = {
      ...
      subject: isConsultation 
        ...
        : isNisa
        ? `【受付完了】NISA初心者勉強会のお申し込み・日程調整のご案内 | 東京米国株クラブ`
        : `【受付完了】米国株投資勉強会お申し込みのご案内 | 東京米国株クラブ`,
      text: isConsultation ? `
${name} 様
...
東京米国株クラブの「NISA初心者勉強会」にお申し込みいただき、誠にありがとうございます。
ご入力いただいた内容を受け付けいたしました。
...
東京米国株クラブの「米国株投資勉強会」にお申し込みいただき、誠にありがとうございます。
...
`,
    ...
    const adminMailOptions = {
      ...
      subject: isConsultation
        ? `【個別相談お申し込み】${name} 様`
        : isNisa
        ? `【NISA初心者勉強会お申し込み】${name} 様`
        : `【米国株勉強会お申し込み】${eventString}`,
      text: isConsultation ? `
...
` : isNisa ? `
以下の内容でNISA初心者勉強会への新規お申し込みがありました。
