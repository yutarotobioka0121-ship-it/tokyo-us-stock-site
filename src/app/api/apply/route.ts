...
東京米国株クラブの「キャッシュフローゲーム会」にお申し込みいただき、誠にありがとうございます。
ご入力いただいたお申し込み内容を受け付けいたしました。

追って運営より、開催場所など詳細なご案内メールをお送りいたします。
...
■今後の流れ
1. ご希望日程を確認し、運営より詳細（会場へのアクセス等）の案内メールを送信いたします。
2. 当日、会場にてお会いしましょう！
...
東京米国株クラブの「米国株投資セミナー」にお申し込みいただき、誠にありがとうございます。
ご入力いただいたお申し込み内容を受け付けいたしました。
...
`,
    ...
    const adminMailOptions = {
      ...
      subject: isConsultation
        ? `【個別相談お申し込み】${name} 様`
        : isNisa
        ? `【NISA初心者セミナーお申し込み】${name} 様`
        : isCfg
        ? `【キャッシュフローゲーム会お申し込み】${name} 様`
        : `【米国株セミナーお申し込み】${eventString}`,
      text: isConsultation ? `
...
` : isNisa ? `
以下の内容でNISA初心者セミナーへの新規お申し込みがありました。
...
※このメールはシステムから自動送信されています。
` : isCfg ? `
以下の内容でキャッシュフローゲーム会への新規お申し込みがありました。
...
※このメールはシステムから自動送信されています。
` : `
以下の内容で米国株投資セミナーへの新規お申し込みがありました。
